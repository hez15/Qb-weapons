...
Config.WeaponsDamage = {
    ...
    [`WEAPON_PISTOL`] = {model = `WEAPON_PISTOL`, modifier = 0.8, disableCriticalHits = true},
    [`WEAPON_PISTOL_MK2`] = {model = `WEAPON_PISTOL_MK2`, modifier = 0.9, disableCriticalHits = true},
    [`WEAPON_COMBATPISTOL`] = {model = `WEAPON_COMBATPISTOL`, modifier = 1.0, disableCriticalHits = true},
    [`WEAPON_APPISTOL`] = {model = `WEAPON_APPISTOL`, modifier = 0.4, disableCriticalHits = true},
